            ...
            <Row>
                <Col md={{ span: 10 }} xs={{ span: 24 }}>
                    <Row>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8, 8]}>
                                <CardMatter title="Yêu cầu báo giá" total={handleTotalQuote(0)} color={3} url={`/tu-van-vien/quotes/0`} />
                ...
                <Col md={{ span: 10, push: 2 }} xs={{ span: 24 }}>
                    <Row>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8, 8]}>
                                <CardMatter title="Hôm nay" total={handleTimeByDay(0)} color={3} url={`/tu-van-vien/calendar`} />
                                ...
                                <CardMatter title="Tất cả" total={time.length} color={3} url={`/tu-van-vien/calendar`} />
                            </Row>
                        </Col>
                    </Row>
                    <Divider />
