            ...
            <Row>
                ...
                <Row>
                        ...
                        <Col md={{ span: 19, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8,8]}>
                                <CardMatter title="Đang thực hiện" color={3} total={handleTotalMatter(0)} url={`/admin/matters/0`} />
                                <CardMatter title="Hoàn thành" color={1} total={handleTotalMatter(1)} url={`/admin/matters/1`} />
                                <CardMatter title="Tất cả" color={3} total={state.matters.length} url={`/admin/matters/all`} />
                    ...
                    <Row>
                        ...
                        <Col md={{ span: 19, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8, 8]}>
                                <CardMatter title="Yêu cầu báo giá" total={handleTotalQuote(0)} color={3} url={`/admin/quotes/0`} />
                                <CardMatter title="Đã gửi báo giá" total={handleTotalQuote(1)} color={1} url={`/admin/quotes/1`} />
                                <CardMatter title="Tất cả" total={state.quotes.length} color={3} url={`/admin/quotes/all`} />
                                <CardMatter title="Đã lên lịch" total={handleTotalQuote(3)} color={2} url={`/admin/quotes/2`} />
                            </Row>
                        </Col>
                    </Row>
                    <Divider style={{paddingTop: 20}}/>
                    <Row>
                        ...
                        <Col md={{ span: 19, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8, 8]}>
                                <CardMatter title="Đã giao" total={handleTotalTask(0)} color={3} url={`tasks/0`} />
                                <CardMatter title="Đã trình" total={handleTotalTask(1)} color={2} url={`tasks/1`} />
                                <CardMatter title="Tất cả" total={state.tasks.length} color={3} url={`tasks/all`} />
                                <CardMatter title="Đã hoàn thành" total={handleTotalTask(2)} color={1} url={`tasks/2`} />
                            </Row>
                        </Col>
                    </Row>
                </Col>
                ...
                <Row>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8, 8]}>
                                <CardMatter title="Đã trình" total={handleTotalFee(0)} color={3} url={`fees/0`} />
                    ...
                    <Row>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={8}>
                                <CardMatter title="Nội bộ" color={2} total={handleTotalBill('NB')} url={`bills/type-bill/NB`} />
                    ...
                    <Row>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8, 8]}>
                                <CardMatter title="Hôm nay" total={handleTimeByDay()} color={2} url={`/admin/calendar`} />
                                <CardMatter title="Tuần này" total={handleTimeByWeek()} color={3} url={`/admin/calendar`} />
                                <CardMatter title="Tháng này" total={handleTimeByWeek()} color={3} url={`/admin/calendar`} />
                                <CardMatter title="Tất cả" total={time.length} color={3} url={`/admin/calendar`} />
                            </Row>
                        </Col>
                    </Row>
                </Col>
