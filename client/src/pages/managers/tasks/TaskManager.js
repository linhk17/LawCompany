        ...
        <>
            ...
            <Row>
                <Col md={{ span: 10 }} xs={{ span: 24 }}>
                    <Row>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8,8]}>
                                <CardMatter title="Đã giao" total={handleTotalTask(0)} color={3} url={`/tro-ly/tasks/0`} />
                                <CardMatter title="Hoàn thành" total={handleTotalTask(2)} color={1} url={`/tro-ly/tasks/2`}/>
                                <CardMatter title="Đã trình" total={handleTotalTask(1)} color={3} url={`/tro-ly/tasks/1`}/>
                                <CardMatter title="Tạm ngưng" total={handleTotalTask(-1)} color={2} url={`/tro-ly/tasks/-1`}/>
                            </Row>
                        </Col>
                    </Row>
                    <Divider />
                    <Row>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8,8]}>
                                <CardMatter title="Đang thực hiện" total={handleTotalMatter(0)} color={3} url={`/tro-ly/matters/0`} />
                                <CardMatter title="Tạm ngưng" total={handleTotalMatter(2)} color={2} url={`/tro-ly/matters/2`}/>
                                <CardMatter title="Tất cả" total={state.matters.length} color={3} url={`/tro-ly/matters/all`}/>
                   ...
                   <Row>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8,8]}>
                                <CardMatter title="Đã trình" total={handleTotalFee(0)} color={3} url={`/tro-ly/fees/0`} />
               ...
               <Row>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8,8]}>
                                <CardMatter title="Hạn hôm nay" color={2} total={handleTotalTaskByDay()} url={`/tro-ly/tasks/day`}/>
                                <CardMatter title="Hạn tuần này" color={3} total={handleTotalTaskByWeek()}  url={`/tro-ly/tasks/week`}/>
                                <CardMatter title="Hạn tháng này" color={3} total={handleTotalTaskByMonth()} url={`/tro-ly/tasks/month`}/>
                    ...
                    <Row>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8, 8]}>
                            <CardMatter title="Hôm nay" total={handleTimeByDay(0)} color={2} url={`/tro-ly/calendar`} />
                                <CardMatter title="Tuần này" total={handleTimeByWeek(1)} color={3} url={`/tro-ly/calendar`} />
                                <CardMatter title="Tháng này" total={handleTimeByMonth(2)} color={3} url={`/tro-ly/calendar`} />
                                <CardMatter title="Tất cả" total={time.length} color={3} url={`/tro-ly/calendar`} />
                            </Row>
                        </Col>
                    </Row>
