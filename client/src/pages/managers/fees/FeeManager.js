                ...
                <Row>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8, 8]}>
                                ...
                                <CardMatter title="Đã thanh toán" color={1} total={handleTotalMatter(2)} />
                            </Row>
                        </Col>
                    </Row>
                    <Divider/>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8, 8]}>
                                {token.account.quyen == 1 ? 
                                 <CardMatter title="Đã trình" total={handleTotalFee(0)} color={0} url={`/${url[token.account.quyen]}/fees/0`} />
                                  : null}
                               
                                <CardMatter title="Đã duyệt" total={handleTotalFee(1)} color={1} url={`/${url[token.account.quyen]}/fees/1`} />
                                <CardMatter title="Đã kết toán" total={handleTotalFee(2)} color={2} url={`fees/2`} />
                                {token.account.quyen == 1 ? <CardMatter title="Từ chối" total={handleTotalFee(3)} color={3} url={`fees/3`} />
                                : null }
