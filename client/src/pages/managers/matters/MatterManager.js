...
function MatterManager() {
    ...
    const handleTotalMatter = (value) => {
        if(value=='all') return state.matters.length
        else {
    ...
    return (
        <>
            <Space wrap direction="horizontal" style={{ marginLeft: 60 }}>
            ...
            <Row>
                <Col md={{ span: 10, push: 1 }} xs={{ span: 24 }}>
                    <Row>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8, 8]}>
                                <CardMatter title="Đang thực hiện" color={3} total={handleTotalMatter(0)} url={`/${url}/matters/0`} />
                                <CardMatter title="Tạm ngưng" color={2} total={handleTotalMatter(2)} url={`/${url}/matters/2`} />
                                <CardMatter title="Hoàn thành" color={1} total={handleTotalMatter(1)} url={`/${url}/matters/1`} />
                                <CardMatter title="Tất cả" color={3} total={handleTotalMatter('all')} url={`/${url}/matters/all`} />
                            </Row>
                        </Col>
                    </Row>
                    <Divider />
                    <Row>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8, 8]}>
                                <CardMatter title="Được phân công" total={handleTotalTask(0)} color={3} url={`tasks/0`} />
                                ...
                                <CardMatter title="Tất cả" total={handleTotalTask(1)} color={3} url={`tasks/all`} />
                            </Row>
                        </Col>
                    </Row>
                ...
                <Row>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8, 8]}>
                                <CardMatter title="Hôm nay" total={handleTimeByDay(0)} color={3} url={`/staff/calendar`} />
                                <CardMatter title="Tuần này" total={handleTimeByWeek(1)} color={2} url={`/staff/calendar`} />
                                <CardMatter title="Tháng này" total={handleTimeByMonth(2)} color={3} url={`/staff/calendar`} />
                                <CardMatter title="Tất cả" total={handleTimeByMonth(2)} color={3} url={`/staff/calendar`} />
                            </Row>
                        </Col>
                    </Row>
                    <Divider />
                    <Row>
                        ...
                        <Col md={{ span: 18, push: 2 }} xs={{ span: 19, push: 1 }}>
                            <Row gutter={[8, 8]}>
                                <CardMatter title="Đã giao" total={handleTotalTaskGiaoCho(0)} color={3} url={`tasks-giao/0`} />
                                ...
                                <CardMatter title="Tất cả" total={handleTotalTaskGiaoCho(2)} color={3} url={`tasks-giao/all`} />
                            </Row>
                        </Col>
                    </Row>
                </Col>
