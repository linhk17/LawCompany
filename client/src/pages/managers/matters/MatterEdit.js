                        ...
                        extra={
                            state.matter.status == 0 ?
                                ...
                                : state.matter.status == 2 ?
                                    ...
                                    : state.matter.status == 1 && token.account.quyen == 1 ?
                                    <Popconfirm
                                        placement="topRight"
                                        title="Thực hiện lại"
                                        description="Bạn có chắc là vụ việc sẽ được thực hiện lại chứ?"
                                        okText="Xác nhận"
                                        cancelText="Hủy"
                                        onConfirm={() => handleOk(0)}
                                    >
                                        <Button className="btn btn-status" icon={<FontAwesomeIcon style={{
                                            color: '#faad14',
                                            marginRight: 10
                                        }} icon={faCirclePlay} />}>Thực hiện lại</Button>
                                    </Popconfirm>
                                    : null
                        }>
